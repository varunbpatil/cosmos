...
('Local JSON', 'destination', 'airbyte/destination-local-json', '0.2.7', 'other', '{"type": "SPEC"}'),
('Local CSV', 'destination', 'airbyte/destination-csv', '0.2.7', 'other', '{"type": "SPEC"}'),
('Postgres', 'destination', 'airbyte/destination-postgres', '0.3.6', 'postgres', '{"type": "SPEC"}'),
('BigQuery', 'destination', 'airbyte/destination-bigquery', '0.3.7', 'bigquery', '{"type": "SPEC"}'),
('BigQuery (denormalized typed struct)', 'destination', 'airbyte/destination-bigquery-denormalized', '0.1.0', 'other', '{"type": "SPEC"}'),
...
('Snowflake', 'destination', 'airbyte/destination-snowflake', '0.3.10', 'snowflake', '{"type": "SPEC"}'),
('S3', 'destination', 'airbyte/destination-s3', '0.1.9', 'other', '{"type": "SPEC"}'),
('Redshift', 'destination', 'airbyte/destination-redshift', '0.3.9', 'redshift', '{"type": "SPEC"}'),
('MeiliSearch', 'destination', 'airbyte/destination-meilisearch', '0.2.7', 'other', '{"type": "SPEC"}'),
('MySQL', 'destination', 'airbyte/destination-mysql', '0.1.7', 'mysql', '{"type": "SPEC"}'),
('MS SQL Server', 'destination', 'airbyte/destination-mssql', '0.1.4', 'other', '{"type": "SPEC"}'),
('Oracle (Alpha)', 'destination', 'airbyte/destination-oracle', '0.1.1', 'other', '{"type": "SPEC"}')
;
...
('Sendgrid', 'source', 'airbyte/source-sendgrid', '0.2.5', '', '{"type": "SPEC"}'),
...
('Facebook Marketing', 'source', 'airbyte/source-facebook-marketing', '0.2.13', '', '{"type": "SPEC"}'),
('Hubspot', 'source', 'airbyte/source-hubspot', '0.1.5', '', '{"type": "SPEC"}'),
('Klaviyo', 'source', 'airbyte/source-klaviyo', '0.1.1', '', '{"type": "SPEC"}'),
('Shopify', 'source', 'airbyte/source-shopify', '0.1.9', '', '{"type": "SPEC"}'),
...
('Intercom', 'source', 'airbyte/source-intercom-singer', '0.2.3', '', '{"type": "SPEC"}'),
('Jira', 'source', 'airbyte/source-jira', '0.2.6', '', '{"type": "SPEC"}'),
('Mixpanel', 'source', 'airbyte/source-mixpanel-singer', '0.2.4', '', '{"type": "SPEC"}'),
...
('Mongo DB', 'source', 'airbyte/source-mongodb', '0.3.2', '', '{"type": "SPEC"}'),
('Google Directory', 'source', 'airbyte/source-google-directory', '0.1.3', '', '{"type": "SPEC"}'),
('Instagram', 'source', 'airbyte/source-instagram', '0.1.6', '', '{"type": "SPEC"}'),
